        ...
        children: [
          Padding(
            ...
            child: AtomSearchInput(
              ...
              placeholder: t.CREATE_MATCH.SEARCH_GAME,
              ...
              ? FutureBuilder(
                  ...
                  builder:
                      (
                        ...
                        AsyncSnapshot<List<MinimalGame>> snapshot,
                      ) {
                        if (!snapshot.hasData) {
                          return Center(
                            child: Row(
                              ...
                              children: [
                                Text(t.CREATE_MATCH.LOADING_RECOMENDATIONS),
          ...
          (counter == 0 && controller.text.isNotEmpty)
              ? FutureBuilder(
                  ...
                  builder:
                      (
                        BuildContext context,
                        AsyncSnapshot<List<TinyRawgGame>> snapshot,
                      ) {
                        if (snapshot.hasData) {
                          return Flexible(
                          ...
                          return Center(
                            child: Text(t.CREATE_MATCH.SEARCH_ERROR),
                          );
                        } else {
