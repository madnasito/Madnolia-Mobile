...
import 'package:madnolia/widgets/alert_widget.dart'
    show showErrorServerAlert, showSuccesfulAlert;
                                                  ...
                                                  onPressed: _isSubmitting
                                                      ...
                                                      : () async {
                                                          try {
                                                            ...
                                                            final UploadReportBody
                                                            body = UploadReportBody(
                                                              type: type,
                                                              to: user.id,
                                                              description:
                                                                  description,
...
class AtomUserPFP extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Stack(
      ...
      children: [
        CircleAvatar(radius: 50, backgroundImage: NetworkImage(userThumb)),
        // Container(
