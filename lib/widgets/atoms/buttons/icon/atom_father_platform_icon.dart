...
class AtomFatherPlatformIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
   final iconSize =
        (platform.size * MediaQuery.of(context).size.width) / 100;
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(
            ...
            width: 2,
            style:
                platform.active ? BorderStyle.solid : BorderStyle.none),
      ...
      child: SvgPicture.asset(
        ...
        colorFilter: (platform.active) 
          ...
          : const ColorFilter.mode(Color.fromARGB(172, 109, 109, 109),
          BlendMode.srcIn
        ),
      ),
    );
