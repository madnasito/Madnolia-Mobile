                ...
                Row(
                  ...
                  children: [
                    DropdownButton<UserAvailability>(
                      ...
                      items: UserAvailability.values.map((UserAvailability availability) {
                          ...
                          child: Container(
                            ...
                            child: Row(
                              children: <Widget>[
                                ...
                                Text(
                                  t.PROFILE.AVAILABILITY.${availability.name.toUpperCase()},
                                ),
                              ],
                            ),
                          ),
                      ...
                      selectedItemBuilder: (BuildContext context) {
                        return UserAvailability.values.map<Widget>((UserAvailability availability) {
                          return Container(
                            alignment: Alignment.center,
                            child: Row(
                              children: <Widget>[
