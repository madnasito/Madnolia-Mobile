      ...
      itemBuilder: (BuildContext context, int index) {
        ...
        return Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: const Color(0xFF00F0FF).withValues(alpha:  0.16), width: 1),
            ...
            title: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: const TextStyle(fontSize: 13, overflow: TextOverflow.ellipsis, color: Colors.white70),
                ) : SizedBox(),
                ...
                Row(
                  children: [
                    ...
                    Text(
                      '${DateFormat('EEE, d MMM').format(matches[index].date)} · ${DateFormat('HH:mm').format(matches[index].date)}',
                      style: const TextStyle(color: Color(0xFF9FFBFF), fontSize: 14, fontWeight: FontWeight.w600),
                      overflow: TextOverflow.ellipsis,
                    ):
                Text(
                    t.MATCH.STATUS.RUNNING,
                    style: const TextStyle(color: Color.fromARGB(255, 142, 255, 236), fontSize: 15),
